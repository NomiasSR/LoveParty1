...
final class zzc extends zzau {
    ...
    public final void zzb(zzp com_google_android_gms_maps_model_internal_zzp) {
        this.zzirc.onMarkerDragStart(new Marker(com_google_android_gms_maps_model_internal_zzp));
    }

    public final void zzc(zzp com_google_android_gms_maps_model_internal_zzp) {
        this.zzirc.onMarkerDragEnd(new Marker(com_google_android_gms_maps_model_internal_zzp));
    }

    public final void zzd(zzp com_google_android_gms_maps_model_internal_zzp) {
        this.zzirc.onMarkerDrag(new Marker(com_google_android_gms_maps_model_internal_zzp));
    }
}
