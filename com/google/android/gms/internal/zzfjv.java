...
public final class zzfjv {
    ...
    public static final int zzb(zzfjj com_google_android_gms_internal_zzfjj, int i) throws IOException {
        int position = com_google_android_gms_internal_zzfjj.getPosition();
        com_google_android_gms_internal_zzfjj.zzkq(i);
        int i2 = 1;
        while (com_google_android_gms_internal_zzfjj.zzcvt() == i) {
            com_google_android_gms_internal_zzfjj.zzkq(i);
            i2++;
        }
        com_google_android_gms_internal_zzfjj.zzam(position, i);
        return i2;
    }
}
