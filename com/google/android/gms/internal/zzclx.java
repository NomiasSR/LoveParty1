    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzpnc != null) {
            if (!this.zzpnc.isEmpty()) {
                return this.zzpnc.equals(com_google_android_gms_internal_zzclx.zzpnc);
            }
        }
        return com_google_android_gms_internal_zzclx.zzpnc == null || com_google_android_gms_internal_zzclx.zzpnc.isEmpty();
    }

    public final int hashCode() {
        int i = 0;
        int hashCode = (((((((((527 + getClass().getName().hashCode()) * 31) + (this.name == null ? 0 : this.name.hashCode())) * 31) + (this.zzjkt == null ? 0 : this.zzjkt.hashCode())) * 31) + (this.zzjku == null ? 0 : this.zzjku.hashCode())) * 31) + (this.zzjkv == null ? 0 : this.zzjkv.hashCode())) * 31;
        if (this.zzpnc != null) {
            if (!this.zzpnc.isEmpty()) {
