    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzpnc != null) {
            if (!this.zzpnc.isEmpty()) {
                return this.zzpnc.equals(com_google_android_gms_internal_zzcmc.zzpnc);
            }
        }
        return com_google_android_gms_internal_zzcmc.zzpnc == null || com_google_android_gms_internal_zzcmc.zzpnc.isEmpty();
    }

    public final int hashCode() {
        int i = 0;
        int hashCode = (((((((((((527 + getClass().getName().hashCode()) * 31) + (this.name == null ? 0 : this.name.hashCode())) * 31) + (this.zzgcc == null ? 0 : this.zzgcc.hashCode())) * 31) + (this.zzjll == null ? 0 : this.zzjll.hashCode())) * 31) + (this.zzjjk == null ? 0 : this.zzjjk.hashCode())) * 31) + (this.zzjjl == null ? 0 : this.zzjjl.hashCode())) * 31;
        if (this.zzpnc != null) {
            if (!this.zzpnc.isEmpty()) {
