...
final class zzfiw extends zzfit {
    ...
    L_0x000d:
        r6 = r4 + r1;
        r4 = com.google.android.gms.internal.zzfiq.zzb(r11, r4);
    ...
    L_0x0021:
        r3 = r12 + r1;
        r12 = com.google.android.gms.internal.zzfiq.zzb(r11, r12);
    ...
    L_0x0047:
        r12 = r3 + r1;
        r3 = com.google.android.gms.internal.zzfiq.zzb(r11, r3);
    ...
    L_0x0072:
        r12 = r7 + r1;
        r3 = com.google.android.gms.internal.zzfiq.zzb(r11, r7);
        if (r3 <= r5) goto L_0x001e;
    L_0x007a:
        return r6;
    L_0x007b:
    ...
    L_0x0083:
        r14 = r14 + -3;
        r7 = r3 + r1;
        r13 = com.google.android.gms.internal.zzfiq.zzb(r11, r3);
            ...
            if (bArr2.length - i4 >= i3) {
                ...
                while (i3 < length) {
                    ...
                    if (charAt < '' && j < j2) {
                        ...
                        r14 = j + 1;
                        zzfiq.zza(bArr2, j, (byte) (960 | (charAt >>> 6)));
                        j = r14 + 1;
                        zzfiq.zza(bArr2, r14, (byte) ((charAt & 63) | 128));
                    } else if ((charAt < '?' || '?' < charAt) && j <= j2 - 3) {
                        r14 = j + 1;
                        zzfiq.zza(bArr2, j, (byte) (480 | (charAt >>> 12)));
                        j = r14 + 1;
                        zzfiq.zza(bArr2, r14, (byte) (((charAt >>> 6) & 63) | 128));
                        r14 = j + 1;
                        zzfiq.zza(bArr2, j, (byte) ((charAt & 63) | 128));
                        j = r14;
                    } else if (j <= j2 - 4) {
                        int i5 = i3 + 1;
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt, charAt2)) {
                                ...
                                r14 = j + 1;
                                zzfiq.zza(bArr2, j, (byte) (240 | (i3 >>> 18)));
                                j = r14 + 1;
                                zzfiq.zza(bArr2, r14, (byte) (((i3 >>> 12) & 63) | 128));
                                r14 = j + 1;
                                zzfiq.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                                j = r14 + 1;
                                zzfiq.zza(bArr2, r14, (byte) ((i3 & 63) | 128));
                                i3 = i5;
                            }
                        } else {
                            i5 = i3;
