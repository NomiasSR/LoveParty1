...
final class zzcxb extends zza<zzcxn, zzcxe> {
    ...
    public final /* synthetic */ zze zza(Context context, Looper looper, zzr com_google_android_gms_common_internal_zzr, Object obj, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        if (com_google_android_gms_internal_zzcxe == null) {
            com_google_android_gms_internal_zzcxe = zzcxe.zzkbs;
        }
        return new zzcxn(context, looper, true, com_google_android_gms_common_internal_zzr, com_google_android_gms_internal_zzcxe, connectionCallbacks, onConnectionFailedListener);
    }
}
