...
public final class zzclf extends zzcjl {
    ...
    private final void zzbe(long j) {
        zzcgs com_google_android_gms_internal_zzcgs;
        long j2;
        zzve();
        zzbav();
        this.zzjjd.cancel();
        ...
        if (zzawz().zzjdg.get()) {
            com_google_android_gms_internal_zzcgs = this.zzjjd;
            j2 = zzawz().zzjde.get();
        } else {
            com_google_android_gms_internal_zzcgs = this.zzjje;
            j2 = 3600000;
        }
        com_google_android_gms_internal_zzcgs.zzs(Math.max(0, j2 - zzawz().zzjdi.get()));
    }
