...
*/
    ...
    L_0x0012:
        ...
        r5 = r5 + r1;	 Catch:{ NotFoundException -> 0x0050 }
        r1 = java.lang.String.valueOf(r6);	 Catch:{ NotFoundException -> 0x0050 }
        r1 = r1.length();	 Catch:{ NotFoundException -> 0x0050 }
        r5 = r5 + r1;	 Catch:{ NotFoundException -> 0x0050 }
        r1 = new java.lang.StringBuilder;	 Catch:{ NotFoundException -> 0x0050 }
        r1.<init>(r5);	 Catch:{ NotFoundException -> 0x0050 }
        r1.append(r7);	 Catch:{ NotFoundException -> 0x0050 }
        r5 = ":string/";	 Catch:{ NotFoundException -> 0x0050 }
        r1.append(r5);	 Catch:{ NotFoundException -> 0x0050 }
        r1.append(r6);	 Catch:{ NotFoundException -> 0x0050 }
        r5 = r1.toString();	 Catch:{ NotFoundException -> 0x0050 }
