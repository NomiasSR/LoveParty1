...
public final class zzu {
    ...
    private static java.lang.String zzcm(android.content.Context r2) {
...
*/
        ...
        r1 = com.google.android.gms.internal.zzbhf.zzdb(r2);	 Catch:{ NameNotFoundException -> 0x0011, NameNotFoundException -> 0x0011 }
        r1 = r1.zzgt(r0);	 Catch:{ NameNotFoundException -> 0x0011, NameNotFoundException -> 0x0011 }
    ...
    L_0x001e:
        return r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.zzu.zzcm(android.content.Context):java.lang.String");
    }

    public static String zzcn(Context context) {
        return context.getResources().getString(C0365R.string.common_google_play_services_notification_channel_name);
    }
    ...
    L_0x006b:
        return r1;
    L_0x006c:
        r3 = com.google.android.gms.C0365R.string.common_google_play_services_enable_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x0073:
        r3 = com.google.android.gms.C0365R.string.common_google_play_services_update_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x007a:
        r3 = com.google.android.gms.C0365R.string.common_google_play_services_install_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x0081:
        r4 = "GoogleApiAvailability";
    ...
    public static String zzh(Context context, int i) {
        ...
        return zzw == null ? context.getResources().getString(C0365R.string.common_google_play_services_notification_ticker) : zzw;
    }
    ...
    public static String zzi(Context context, int i) {
        ...
        if (i == 9) {
            return resources.getString(C0365R.string.common_google_play_services_unsupported_text, new Object[]{zzcm});
        } else if (i == 20) {
            return zzl(context, "common_google_play_services_restricted_profile_text", zzcm);
        } else {
            switch (i) {
                case 1:
                    return resources.getString(C0365R.string.common_google_play_services_install_text, new Object[]{zzcm});
                case 2:
                    if (zzi.zzct(context)) {
                        return resources.getString(C0365R.string.common_google_play_services_wear_update_text);
                    }
                    return resources.getString(C0365R.string.common_google_play_services_update_text, new Object[]{zzcm});
                case 3:
                    return resources.getString(C0365R.string.common_google_play_services_enable_text, new Object[]{zzcm});
                default:
                    switch (i) {
                        case 16:
                        ...
                        case 18:
                            return resources.getString(C0365R.string.common_google_play_services_updating_text, new Object[]{zzcm});
                        default:
                            return resources.getString(C0365R.string.common_google_play_services_unknown_issue, new Object[]{zzcm});
                    }
            }
        }
    }
    ...
    public static String zzk(Context context, int i) {
        ...
        switch (i) {
            case 1:
                i = C0365R.string.common_google_play_services_install_button;
                break;
            case 2:
                i = C0365R.string.common_google_play_services_update_button;
                break;
            case 3:
                i = C0365R.string.common_google_play_services_enable_button;
                break;
            default:
                i = 17039370;
                break;
    ...
    private static String zzl(Context context, String str, String str2) {
        ...
        if (zzw == null) {
            zzw = resources.getString(C0365R.string.common_google_play_services_unknown_issue);
        }
