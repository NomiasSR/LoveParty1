...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C05412();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C03941();
    ...
    static class C03941 extends ThreadLocal<StringBuilder> {
        C03941() {
        }
    ...
    static class C05412 extends RequestHandler {
