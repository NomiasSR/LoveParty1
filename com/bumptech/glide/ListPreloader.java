...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C04911 implements PreloadModelProvider<T> {
        C04911() {
        }
    ...
    class C04922 implements PreloadSizeProvider<T> {
        C04922() {
        }
    ...
    public ListPreloader(int i) {
        ...
        this.preloadModelProvider = new C04911();
        this.preloadDimensionProvider = new C04922();
        this.maxPreload = i;
