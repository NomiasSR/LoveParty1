...
*/
    ...
    private void analyzePixels() {
        ...
        for (i = 0; i < this.colorTab.length; i += 3) {
            ...
            int i3 = i + 2;
            this.colorTab[i] = this.colorTab[i3];
            this.colorTab[i3] = b;
        ...
        while (i < i2) {
            ...
            i3 = i5 + 1;
            int i6 = i3 + 1;
            i4 = neuQuant.map(this.pixels[i4] & 255, this.pixels[i5] & 255, this.pixels[i3] & 255);
    ...
    private void getImagePixels() {
        ...
        double length2 = ((double) (100 * i2)) / ((double) iArr.length);
