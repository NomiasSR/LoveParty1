...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    public static final Downsampler AT_LEAST = new C05631();
    public static final Downsampler AT_MOST = new C05642();
    private static final int MARK_POSITION = 5242880;
    public static final Downsampler NONE = new C05653();
    ...
    static class C05631 extends Downsampler {
        public String getId() {
    ...
    static class C05642 extends Downsampler {
        public String getId() {
    ...
    static class C05653 extends Downsampler {
        public String getId() {
