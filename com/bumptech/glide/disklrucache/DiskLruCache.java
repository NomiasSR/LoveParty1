...
public final class DiskLruCache implements Closeable {
    ...
    private final Callable<Void> cleanupCallable = new C03151();
    ...
    class C03151 implements Callable<Void> {
        C03151() {
        }
...
*/
    ...
    public synchronized boolean remove(java.lang.String r8) throws java.io.IOException {
        ...
        r7 = this;
        monitor-enter(r7);
        r7.checkNotClosed();	 Catch:{ all -> 0x008d }
        r0 = r7.lruEntries;	 Catch:{ all -> 0x008d }
        r0 = r0.get(r8);	 Catch:{ all -> 0x008d }
        r0 = (com.bumptech.glide.disklrucache.DiskLruCache.Entry) r0;	 Catch:{ all -> 0x008d }
        r1 = 0;
        if (r0 == 0) goto L_0x008b;
    L_0x000f:
        r2 = r0.currentEditor;	 Catch:{ all -> 0x008d }
        if (r2 == 0) goto L_0x0016;
    L_0x0015:
        goto L_0x008b;
    L_0x0016:
        r2 = r7.valueCount;	 Catch:{ all -> 0x008d }
        if (r1 >= r2) goto L_0x0057;
    L_0x001a:
        r2 = r0.getCleanFile(r1);	 Catch:{ all -> 0x008d }
        r3 = r2.exists();	 Catch:{ all -> 0x008d }
        if (r3 == 0) goto L_0x0041;
    L_0x0024:
        r3 = r2.delete();	 Catch:{ all -> 0x008d }
        if (r3 != 0) goto L_0x0041;
    L_0x002a:
        r8 = new java.io.IOException;	 Catch:{ all -> 0x008d }
    ...
    L_0x0041:
        r2 = r7.size;	 Catch:{ all -> 0x008d }
        r4 = r0.lengths;	 Catch:{ all -> 0x008d }
        r5 = r4[r1];	 Catch:{ all -> 0x008d }
        r2 = r2 - r5;
        r7.size = r2;	 Catch:{ all -> 0x008d }
        r2 = r0.lengths;	 Catch:{ all -> 0x008d }
        r3 = 0;
        r2[r1] = r3;	 Catch:{ all -> 0x008d }
        r1 = r1 + 1;
        goto L_0x0016;
    L_0x0057:
        r0 = r7.redundantOpCount;	 Catch:{ all -> 0x008d }
        r1 = 1;
        r0 = r0 + r1;
        r7.redundantOpCount = r0;	 Catch:{ all -> 0x008d }
        r0 = r7.journalWriter;	 Catch:{ all -> 0x008d }
        r2 = "REMOVE";
        r0.append(r2);	 Catch:{ all -> 0x008d }
        r0 = r7.journalWriter;	 Catch:{ all -> 0x008d }
        r2 = 32;
        r0.append(r2);	 Catch:{ all -> 0x008d }
        r0 = r7.journalWriter;	 Catch:{ all -> 0x008d }
        r0.append(r8);	 Catch:{ all -> 0x008d }
        r0 = r7.journalWriter;	 Catch:{ all -> 0x008d }
        r2 = 10;
        r0.append(r2);	 Catch:{ all -> 0x008d }
        r0 = r7.lruEntries;	 Catch:{ all -> 0x008d }
        r0.remove(r8);	 Catch:{ all -> 0x008d }
        r8 = r7.journalRebuildRequired();	 Catch:{ all -> 0x008d }
        if (r8 == 0) goto L_0x0089;
    L_0x0082:
        r8 = r7.executorService;	 Catch:{ all -> 0x008d }
        r0 = r7.cleanupCallable;	 Catch:{ all -> 0x008d }
