            ...
            if ((1 == getLayoutDirection() ? 1 : null) != null) {
                if (this.startToEnd != -1) {
                    ...
                    if (this.isGuideline && this.orientation == 1) {
                        if (this.guidePercent != GroundOverlayOptions.NO_DIMENSION) {
                            ...
                            this.resolvedGuideBegin = -1;
                            this.resolvedGuidePercent = GroundOverlayOptions.NO_DIMENSION;
...
*/
                    ...
                    if (!layoutParams.isHelper) {
                        ...
                        if (i9 != 0) {
                            if (i3 != 0) {
                                ...
                                constraintWidget.setHeightWrapContent(i3 == -2);
                                i6 = childAt.getMeasuredWidth();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (z && size == r0.mLastMeasureWidthSize) {
            int i8 = r0.mLastMeasureHeightSize;
        }
        ...
        if (i3 > 0) {
            ...
            int i14 = 0;
            while (i13 < i3) {
                ConstraintWidget constraintWidget = (ConstraintWidget) r0.mVariableDimensionsWidgets.get(i13);
                            ...
                            if (view.getVisibility() != 8) {
                                if (!z || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved()) {
                                    if (layoutParams.width == -2 && layoutParams.horizontalDimensionFixed) {
                                        size2 = getChildMeasureSpec(i4, mode, layoutParams.width);
                                    } else {
                                    ...
                                    if (layoutParams.height == -2 && layoutParams.verticalDimensionFixed) {
                                        i4 = getChildMeasureSpec(i5, size, layoutParams.height);
                                    } else {
                                        i4 = MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), 1073741824);
                                    }
                                    view.measure(size2, i4);
                                    if (r0.mMetrics != null) {
                                    ...
                                    if (layoutParams.needsBaseline) {
                                        i4 = view.getBaseline();
                                        if (!(i4 == -1 || i4 == constraintWidget.getBaselineDistance())) {
            ...
            i6 = i14;
            if (obj3 != null) {
                r0.mLayoutWidget.setWidth(i9);
                r0.mLayoutWidget.setHeight(i10);
                if (z) {
                    r0.mLayoutWidget.solveGraph();
                }
                solveLinearSystem("2nd pass");
                if (r0.mLayoutWidget.getWidth() < i12) {
                    r0.mLayoutWidget.setWidth(i12);
                    obj2 = 1;
                } else {
                    obj2 = null;
                }
            ...
            i4 = i11;
            for (mode2 = 0; mode2 < i4; mode2++) {
                ConstraintWidget constraintWidget2 = (ConstraintWidget) r0.mVariableDimensionsWidgets.get(mode2);
        ...
        i4 = r0.mLayoutWidget.getWidth() + mode;
        mode = r0.mLayoutWidget.getHeight() + size;
        if (VERSION.SDK_INT >= 11) {
            i5 = resolveSizeAndState(mode, i5, i6 << 16) & ViewCompat.MEASURED_SIZE_MASK;
            i4 = Math.min(r0.mMaxWidth, resolveSizeAndState(i4, i, i6) & ViewCompat.MEASURED_SIZE_MASK);
            i5 = Math.min(r0.mMaxHeight, i5);
            ...
            r0.mLastMeasureWidth = i4;
            r0.mLastMeasureHeight = i5;
            return;
        }
        setMeasuredDimension(i4, mode);
        r0.mLastMeasureWidth = i4;
        r0.mLastMeasureHeight = mode;
    }
