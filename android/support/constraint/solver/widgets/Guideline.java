    ...
    public void analyze(int i) {
        ...
        if (i != 0) {
            ...
            if (getOrientation() == 1) {
                ...
                } else if (this.mRelativePercent != GroundOverlayOptions.NO_DIMENSION && i.getHorizontalDimensionBehaviour() == DimensionBehaviour.FIXED) {
                ...
                } else if (this.mRelativePercent != GroundOverlayOptions.NO_DIMENSION && i.getVerticalDimensionBehaviour() == DimensionBehaviour.FIXED) {
