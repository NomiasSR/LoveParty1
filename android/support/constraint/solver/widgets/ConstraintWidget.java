            ...
            if (!isConnected && !isConnected2 && !isConnected3) {
                ...
                if (obj != null) {
                    if (z2) {
                        ...
                        if (i20 <= 0) {
                            i10 = 6;
                            linearSystem2.addGreaterThan(createObjectVariable2, createObjectVariable, i20, 6);
                        } else {
                            i10 = 6;
                        }
                        i20 = i4;
                        if (i20 < ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) {
                            linearSystem2.addLowerThan(createObjectVariable2, createObjectVariable, i20, i10);
                        }
                    }
                    i11 = i7;
                    solverVariable5 = createObjectVariable3;
                    ...
                    if (i16 <= 0) {
                        if (z) {
                            i20 = 6;
                            linearSystem2.addGreaterThan(createObjectVariable2, createObjectVariable, i16, 6);
                        } else {
                            i20 = 6;
                            linearSystem2.addGreaterThan(createObjectVariable2, createObjectVariable, i16, 6);
                        }
                    ...
                    if (i11 > 0) {
                        if (z) {
                            linearSystem2.addLowerThan(createObjectVariable2, createObjectVariable, i11, i20);
                        } else {
                    ...
                    if (i10 != 1) {
                        if (z) {
                            if (z4) {
                                linearSystem2.addEquality(createObjectVariable2, createObjectVariable, i20, 1);
                                i12 = i10;
                                i17 = i20;
                                i10 = i22;
                                i13 = 2;
                                i15 = 4;
                                SolverVariable solverVariable15 = createObjectVariable4;
                                i14 = 1;
                                solverVariable3 = solverVariable15;
                            } else {
                                linearSystem2.addEquality(createObjectVariable2, createObjectVariable, i20, 4);
                                i12 = i10;
                                i15 = 4;
                                i17 = i20;
                                solverVariable3 = createObjectVariable4;
                            ...
                            if (!(obj == null || r8 == r0 || z3)) {
                                i17 = Math.max(i16, i17);
                                if (i11 > 0) {
                                    i17 = Math.min(i11, i17);
                                }
                                linearSystem2.addEquality(createObjectVariable2, createObjectVariable, i17, 6);
                                obj = null;
                            }
                        } else {
                            linearSystem2.addEquality(createObjectVariable2, createObjectVariable, i20, 6);
                            i12 = i10;
                            i17 = i20;
                            solverVariable3 = createObjectVariable4;
                            i10 = i22;
                        ...
                        solverVariable3 = linearSystem2.createObjectVariable(constraintWidget.mParent.getAnchor(Type.TOP));
                ...
                if (z5) {
                    if (z4) {
                        i13 = 5;
                        if (!isConnected || isConnected2 || r25) {
                            i19 = 0;
                            solverVariable7 = solverVariable2;
                            if (!isConnected && !isConnected2) {
                                if (z) {
                                    linearSystem2.addGreaterThan(solverVariable7, createObjectVariable2, 0, 5);
                                }
                                solverVariable8 = createObjectVariable2;
                                i8 = 6;
                                if (z) {
                                    linearSystem2.addGreaterThan(solverVariable2, solverVariable8, i19, i8);
                                }
                                return;
                            } else if (isConnected && isConnected2) {
                                ...
                                if (isConnected && isConnected2) {
                                    if (obj == null) {
                                        ...
                                        if (i12 != 0) {
                                            if (i11 <= 0) {
                                                if (i16 > 0) {
                                                    ...
                                                    linearSystem2.addEquality(createObjectVariable2, solverVariable3, -constraintAnchor2.getMargin(), i8);
                                                    if (i11 <= 0) {
                                                        if (i16 <= 0) {
                                                            i10 = 0;
                                                        }
                                        ...
                                        if (i10 == 0) {
                                            ...
                                            linearSystem2.addCentering(createObjectVariable, solverVariable10, constraintAnchor.getMargin(), f, solverVariable3, createObjectVariable2, constraintAnchor2.getMargin(), i13);
                                        } else {
                                            solverVariable7 = solverVariable10;
                                            solverVariable11 = createObjectVariable2;
                                            solverVariable9 = createObjectVariable;
                                        ...
                                        if (i11 == 0) {
                                            i8 = 6;
                                            linearSystem2.addGreaterThan(solverVariable9, solverVariable7, constraintAnchor.getMargin(), 6);
                                            solverVariable8 = solverVariable11;
                                            linearSystem2.addLowerThan(solverVariable8, solverVariable3, -constraintAnchor2.getMargin(), 6);
                                        } else {
                                            solverVariable8 = solverVariable11;
                                            i8 = 6;
                                        }
                                        if (z) {
                                            i19 = 0;
                                            linearSystem2.addGreaterThan(solverVariable9, solverVariable, 0, i8);
                                            if (z) {
                                                linearSystem2.addGreaterThan(solverVariable2, solverVariable8, i19, i8);
                                            }
                                            return;
                                    ...
                                    if (z) {
                                        ...
                                        linearSystem2.addLowerThan(createObjectVariable2, solverVariable3, -constraintAnchor2.getMargin(), 5);
                                    }
                                    i11 = 0;
                                    if (i10 == 0) {
                                        solverVariable7 = solverVariable10;
                ...
                if (i10 < i16 && z) {
                    ...
                    linearSystem2.addGreaterThan(solverVariable14, solverVariable8, 0, 6);
                }
            }
        }
        i11 = 6;
        if (obj != null) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    if (constraintAnchor.getType() != Type.TOP) {
                        if (constraintAnchor.getType() == Type.BOTTOM) {
                            ...
                            createObjectVariable5 = linearSystem2.createObjectVariable(constraintWidget.mParent.getAnchor(Type.RIGHT));
                            solverVariable6 = createObjectVariable62;
                            i12 = i10;
                            solverVariable3 = createObjectVariable4;
                            i10 = i22;
                            i17 = i18;
                ...
                if (z4) {
                    ...
                    i13 = 2;
                    i15 = 4;
                    SolverVariable solverVariable152 = createObjectVariable4;
                    i14 = 1;
                    solverVariable3 = solverVariable152;
                } else {
                    linearSystem2.addEquality(createObjectVariable2, createObjectVariable, i20, 4);
                    i12 = i10;
                    i15 = 4;
