...
public class ArrayRow implements Row {
                ...
                if (i4 != 0) {
                    ...
                    if (i == 0) {
                        if (variableValue < 0.0f) {
                            ...
                            stringBuilder.append("- ");
                            str = stringBuilder.toString();
                            variableValue *= GroundOverlayOptions.NO_DIMENSION;
                        }
                    } else if (i4 > 0) {
                        stringBuilder = new StringBuilder();
                        stringBuilder.append(str);
    ...
    public ArrayRow createRowEquals(SolverVariable solverVariable, int i) {
        if (i < 0) {
            ...
            this.variables.put(solverVariable, GroundOverlayOptions.NO_DIMENSION);
        }
        return this;
    }
    ...
    public ArrayRow createRowEquals(SolverVariable solverVariable, SolverVariable solverVariable2, int i) {
        ...
        if (obj == null) {
            ...
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, GroundOverlayOptions.NO_DIMENSION);
        }
        return this;
    }
    ...
    public ArrayRow createRowGreaterThan(SolverVariable solverVariable, SolverVariable solverVariable2, SolverVariable solverVariable3, int i) {
        ...
        if (obj == null) {
            ...
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, GroundOverlayOptions.NO_DIMENSION);
            this.variables.put(solverVariable3, GroundOverlayOptions.NO_DIMENSION);
        }
        return this;
    }
    ...
    ArrayRow createRowCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i, float f, SolverVariable solverVariable3, SolverVariable solverVariable4, int i2) {
        ...
        if (f == 0.5f) {
            ...
            this.variables.put(solverVariable2, GroundOverlayOptions.NO_DIMENSION * f2);
            this.variables.put(solverVariable3, GroundOverlayOptions.NO_DIMENSION * f);
    ...
    void pivot(SolverVariable solverVariable) {
        ...
        float remove = this.variables.remove(solverVariable, true) * GroundOverlayOptions.NO_DIMENSION;
        this.variable = solverVariable;
        if (remove != 1.0f) {
