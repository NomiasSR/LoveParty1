...
public class ChangeTransform extends Transition {
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final boolean z2 = z;
        TransitionValues c00703 = new AnimatorListenerAdapter() {
        ...
        transitionValues.addListener(c00703);
        AnimatorUtils.addPauseListener(transitionValues, c00703);
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0075R.id.parent_matrix, matrix);
