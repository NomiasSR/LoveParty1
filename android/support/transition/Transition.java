...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C04251();
    ...
    static class C04251 extends PathMotion {
        C04251() {
        }
                        ...
                        if (obj != null) {
                            ...
                            if (createAnimator != null) {
                                ...
                                if (obj2 == null) {
                                    ...
                                    j2 = j;
                                    runningAnimators.put(obj2, new AnimationInfo(view, getName(), transition, ViewUtils.getWindowId(viewGroup), transitionValues4));
