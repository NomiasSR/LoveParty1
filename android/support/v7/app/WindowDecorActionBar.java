...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C05571();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C05582();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04623();

    class C04623 implements ViewPropertyAnimatorUpdateListener {
        C04623() {
        }
    ...
    class C05571 extends ViewPropertyAnimatorListenerAdapter {
        C05571() {
        }
...
*/
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0238R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0238R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0238R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0238R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!actionBarPolicy.enableHomeButtonByDefault()) {
                    if (view == null) {
                        ...
                        view = this.mContext.obtainStyledAttributes(null, C0238R.styleable.ActionBar, C0238R.attr.actionBarStyle, 0);
                        if (view.getBoolean(C0238R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        dimensionPixelSize = view.getDimensionPixelSize(C0238R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0238R.attr.actionBarWidgetTheme, typedValue, true);
