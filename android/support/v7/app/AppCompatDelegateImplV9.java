...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02355 implements Runnable {
        ...
        class C05541 extends ViewPropertyAnimatorListenerAdapter {
            C05541() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C05541());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            context = contextThemeWrapper.obtainStyledAttributes(C0238R.styleable.AppCompatTheme);
            this.background = context.getResourceId(C0238R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = context.getResourceId(C0238R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            context.recycle();
        }
    ...
    class C04582 implements OnApplyWindowInsetsListener {
        C04582() {
        }
    ...
    class C04593 implements OnFitSystemWindowsListener {
        C04593() {
        }
    ...
    class C04604 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C05561 extends ViewPropertyAnimatorListenerAdapter {
            C05561() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C05561());
            }
    ...
    class C05556 extends ViewPropertyAnimatorListenerAdapter {
        C05556() {
        }
    ...
    private ViewGroup createSubDecor() {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0238R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0238R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0238R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    view = (ViewGroup) from.inflate(C0238R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    view = (ViewGroup) from.inflate(C0238R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view, new C04582());
                } else {
                    ((FitWindowsViewGroup) view).setOnFitSystemWindowsListener(new C04593());
                }
            } else if (this.mIsFloating) {
                view = (ViewGroup) from.inflate(C0238R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context contextThemeWrapper;
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0238R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                view = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0238R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) view.findViewById(C0238R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) view.findViewById(C0238R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(view);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0238R.id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C04604());
            return view;
        }
        obtainStyledAttributes.recycle();
...
*/
    ...
    L_0x0039:
        ...
        r4 = r7.mContext;
        r4 = r4.getTheme();
        r5 = android.support.v7.appcompat.C0238R.attr.actionBarTheme;
    ...
    L_0x0070:
        ...
        r6 = android.support.v7.appcompat.C0238R.attr.actionModePopupWindowStyle;
        r5.<init>(r4, r1, r6);
        ...
        r5.setWidth(r6);
        r5 = r4.getTheme();
        r6 = android.support.v7.appcompat.C0238R.attr.actionBarSize;
    ...
    L_0x00bd:
        r0 = r7.mSubDecor;
        r4 = android.support.v7.appcompat.C0238R.id.action_mode_bar_stub;
