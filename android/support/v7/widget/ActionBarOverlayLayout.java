...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02541 extends AnimatorListenerAdapter {
        C02541() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02541();
        this.mRemoveActionBarHideOffset = new C02552();
        this.mAddActionBarHideOffset = new C02563();
        init(context);
