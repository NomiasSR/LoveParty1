...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02581 extends DataSetObserver {
        C02581() {
        }
    ...
    class C02592 implements OnGlobalLayoutListener {
        C02592() {
        }
    ...
    class C02603 extends AccessibilityDelegate {
        C02603() {
        }
    ...
    class C02615 extends DataSetObserver {
        C02615() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0238R.id.list_item) {
                    ...
                    ((ImageView) view.findViewById(C0238R.id.icon)).setImageDrawable(resolveInfo.loadIcon(viewGroup));
                    ((TextView) view.findViewById(C0238R.id.title)).setText(resolveInfo.loadLabel(viewGroup));
                ...
                case 1:
                    if (view == null || view.getId() != 1) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0238R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        view.setId(1);
                        ((TextView) view.findViewById(C0238R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0238R.string.abc_activity_chooser_view_see_all));
                    }
                    return view;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetObserver = new C02581();
        this.mOnGlobalLayoutListener = new C02592();
        this.mInitialActivityCount = 4;
        attributeSet = context.obtainStyledAttributes(attributeSet, C0238R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = attributeSet.getInt(C0238R.styleable.ActivityChooserView_initialActivityCount, 4);
        i = attributeSet.getDrawable(C0238R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        ...
        FrameLayout frameLayout = (FrameLayout) findViewById(C0238R.id.expand_activities_button);
        frameLayout.setOnClickListener(this.mCallbacks);
        frameLayout.setAccessibilityDelegate(new C02603());
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0238R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(i);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C02615());
        context = context.getResources();
        this.mListPopupMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0238R.dimen.abc_config_prefDialogWidth));
    }
        ...
        if (!i.isShowing()) {
            if (!this.mIsSelectingDefaultActivity) {
                if (z) {
                    ...
                    i.getListView().setContentDescription(getContext().getString(C0238R.string.abc_activitychooserview_choose_application));
