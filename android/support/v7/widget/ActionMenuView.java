...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i15 > 0 && i10 > 0) {
            ...
            while (paddingTop < i3) {
                ...
                if (!layoutParams3.expandable) {
                    ...
                    i20 = paddingTop;
                    i18 = layoutParams3.cellsUsed;
                    j2 = (long) (1 << paddingTop);
                    i19 = 1;
                } else {
                    i20 = paddingTop;
                    if (layoutParams3.cellsUsed == i18) {
                        i19++;
                        j2 |= (long) (1 << i20);
                    }
                }
            ...
            while (size < i3) {
                ...
                if ((j2 & j3) != 0) {
                    ...
                    i10--;
                } else if (layoutParams4.cellsUsed == i18) {
                    j |= j3;
                }
                size++;
                i11 = i6;
        ...
        if (i12 == 0) {
            ...
            if (i13 == 1) {
                paddingTop = 1;
                if (i10 > 0 || j4 == 0 || (i10 >= i13 - r4 && paddingTop == 0 && i14 <= r4)) {
                    paddingLeft = i8;
                    paddingTop = 0;
                    z2 = z;
                } else {
                    ...
                    if (paddingTop == 0) {
                        ...
                        i3 = i8 - 1;
                        if (!((((long) (1 << i3)) & j4) == 0 || ((LayoutParams) getChildAt(i3).getLayoutParams()).preventEdgeOffset)) {
                            bitCount -= 0.5f;
                        }
                    } else {
                        paddingTop = 0;
                    }
                    i19 = bitCount > 0.0f ? (int) (((float) (i10 * i9)) / bitCount) : paddingTop;
                    z2 = z;
                    paddingLeft = i8;
                    for (childMeasureSpec = paddingTop; childMeasureSpec < paddingLeft; childMeasureSpec++) {
                        if ((((long) (1 << childMeasureSpec)) & j4) != 0) {
                            View childAt4 = getChildAt(childMeasureSpec);
                            LayoutParams layoutParams5 = (LayoutParams) childAt4.getLayoutParams();
                            if (childAt4 instanceof ActionMenuItemView) {
                                layoutParams5.extraPixels = i19;
                                layoutParams5.expanded = true;
                                if (childMeasureSpec == 0 && !layoutParams5.preventEdgeOffset) {
                                    layoutParams5.leftMargin = (-i19) / 2;
                                }
                                z2 = true;
                            } else if (layoutParams5.isOverflowButton) {
                                layoutParams5.extraPixels = i19;
                                layoutParams5.expanded = true;
                                layoutParams5.rightMargin = (-i19) / 2;
                                z2 = true;
                            } else {
                                if (childMeasureSpec != 0) {
                                    layoutParams5.leftMargin = i19 / 2;
                                }
                                if (childMeasureSpec != paddingLeft - 1) {
                                    layoutParams5.rightMargin = i19 / 2;
                                }
                            }
                        }
                ...
                if (z2) {
                    while (paddingTop < paddingLeft) {
                        childAt = getChildAt(paddingTop);
