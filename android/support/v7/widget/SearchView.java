...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02873 implements OnFocusChangeListener {
        C02873() {
        }
    ...
    class C02884 implements OnLayoutChangeListener {
        C02884() {
        }
    ...
    class C02895 implements OnClickListener {
        C02895() {
        }
    ...
    class C02906 implements OnKeyListener {
        C02906() {
        }
    ...
    class C02917 implements OnEditorActionListener {
        C02917() {
        }
    ...
    class C02928 implements OnItemClickListener {
        C02928() {
        }
    ...
    class C02939 implements OnItemSelectedListener {
...
*/
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            ...
            this.mRunShowSoftInputIfNecessary = new C02951();
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02851();
        this.mReleaseCursorRunnable = new C02862();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02895();
        this.mTextKeyListener = new C02906();
        this.mOnEditorActionListener = new C02917();
        this.mOnItemClickListener = new C02928();
        this.mOnItemSelectedListener = new C02939();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0238R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0238R.styleable.SearchView_layout, C0238R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0238R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0238R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0238R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0238R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0238R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0238R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0238R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0238R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0238R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0238R.styleable.SearchView_suggestionRowLayout, C0238R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0238R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02873());
        setIconifiedByDefault(attributeSet.getBoolean(C0238R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0238R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0238R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0238R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0238R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0238R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0238R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02884());
        }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0238R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0238R.dimen.abc_dropdownitem_text_padding_left) : 0;
