...
import android.support.v7.recyclerview.C0242R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02823();
    ...
    static class C02823 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04831();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04842();
        private int mWidth;
        ...
        class C04831 implements Callback {
            C04831() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0242R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0242R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0242R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0242R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0242R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
...
*/
    ...
    class C04804 implements ProcessCallback {
        C04804() {
        }
    ...
    class C04815 implements Callback {
        C04815() {
        }
    ...
    class C04826 implements Callback {
        C04826() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02831();
        Parcelable mLayoutState;

        static class C02831 implements ClassLoaderCreator<SavedState> {
            C02831() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02801();
        ...
        this.mItemAnimatorRunner = new C02812();
        this.mViewInfoProcessCallback = new C04804();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0242R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0242R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0242R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0242R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0242R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0242R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0242R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0242R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04815());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04826());
    }
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                if (!(isInEditMode() || display == null)) {
                    ...
                    if (refreshRate >= BitmapDescriptorFactory.HUE_ORANGE) {
                        this.mGapWorker.mFrameIntervalNs = (long) (1.0E9f / refreshRate);
                        GapWorker.sGapWorker.set(this.mGapWorker);
                    }
                }
                refreshRate = BitmapDescriptorFactory.HUE_YELLOW;
                this.mGapWorker.mFrameIntervalNs = (long) (1.0E9f / refreshRate);
                GapWorker.sGapWorker.set(this.mGapWorker);
            }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (!(stateListDrawable == null || drawable == null || stateListDrawable2 == null)) {
            if (drawable2 != null) {
                ...
                FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0242R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0242R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0242R.dimen.fastscroll_margin));
                return;
            }
        }
