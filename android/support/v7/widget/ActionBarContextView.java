...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0238R.styleable.ActionMode, i, 0);
        ViewCompat.setBackground(this, context.getDrawable(C0238R.styleable.ActionMode_background));
        this.mTitleStyleRes = context.getResourceId(C0238R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = context.getResourceId(C0238R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = context.getLayoutDimension(C0238R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = context.getResourceId(C0238R.styleable.ActionMode_closeItemLayout, C0238R.layout.abc_action_mode_close_item_material);
        context.recycle();
    }
