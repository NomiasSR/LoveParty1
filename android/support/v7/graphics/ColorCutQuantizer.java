...
final class ColorCutQuantizer {
    ...
    private static final Comparator<Vbox> VBOX_COMPARATOR_VOLUME = new C02391();
    final int[] mColors;
    ...
    static class C02391 implements Comparator<Vbox> {
        C02391() {
        }
    ...
    ColorCutQuantizer(int[] iArr, int i, Filter[] filterArr) {
        ...
        while (quantizeFromRgb888 < filterArr.length) {
