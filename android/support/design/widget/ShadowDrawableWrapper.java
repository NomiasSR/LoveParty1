...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        f8 = f;
        canvas2.scale(f7, f8);
        canvas2.rotate(BitmapDescriptorFactory.HUE_CYAN);
        canvas2.drawPath(r0.mCornerShadowPath, r0.mCornerShadowPaint);
        if (obj != null) {
            canvas2.scale(SHADOW_BOTTOM_SCALE / f7, SHADOW_BOTTOM_SCALE);
            f3 = f2;
        ...
        canvas2.scale(f7, f2);
        canvas2.rotate(BitmapDescriptorFactory.HUE_VIOLET);
        canvas2.drawPath(r0.mCornerShadowPath, r0.mCornerShadowPaint);
        if (obj2 != null) {
    ...
    private void buildShadowCorners() {
        ...
        r0.mCornerShadowPath.arcTo(rectF2, BitmapDescriptorFactory.HUE_CYAN, 90.0f, false);
        r0.mCornerShadowPath.arcTo(rectF, BitmapDescriptorFactory.HUE_VIOLET, -90.0f, false);
