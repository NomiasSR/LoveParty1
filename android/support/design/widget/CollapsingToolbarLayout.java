...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C04201 implements OnApplyWindowInsetsListener {
        C04201() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mScrimAnimationDuration = (long) context.getInt(C0012R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, DEFAULT_SCRIM_ANIMATION_DURATION);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04201());
    }
