...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C04113();
    ...
    class C04102 implements OnApplyWindowInsetsListener {
        C04102() {
        }
    ...
    class C04124 implements OnDismissListener {
        C04124() {
        }
    ...
    class C04135 implements OnAttachStateChangeListener {
    ...
    class C04146 implements OnLayoutChangeListener {
        C04146() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C04102());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C04124());
                layoutParams2.setBehavior(behavior);
                layoutParams2.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C04135());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C04146());
