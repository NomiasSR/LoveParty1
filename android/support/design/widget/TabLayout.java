...
public class TabLayout extends HorizontalScrollView {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (this.mTextView != null) {
                ...
                if (tabMaxWidth != 0 || (maxLines >= 0 && mode != maxLines)) {
                    if (TabLayout.this.mMode == 1 && tabMaxWidth > 0 && lineCount == 1) {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(this.mTabTextAppearance, C0238R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) context.getDimensionPixelSize(C0238R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = context.getColorStateList(C0238R.styleable.TextAppearance_android_textColor);
