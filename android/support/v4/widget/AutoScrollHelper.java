...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            return 0.5f * AutoScrollHelper.constrain(((float) (j - this.mStartTime)) / ((float) this.mRampUpDuration), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY);
        }
    ...
    private float getEdgeValue(float f, float f2, float f3, float f4) {
        ...
        return constrain(f, (float) GroundOverlayOptions.NO_DIMENSION, (float) DEFAULT_RELATIVE_VELOCITY);
    }
