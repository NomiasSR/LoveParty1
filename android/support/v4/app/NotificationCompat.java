...
*/
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != 0) {
                if (VERSION.SDK_INT >= 16) {
                    ...
                    remoteViews.setImageViewBitmap(C0003R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0003R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon) {
                    z = resources.getDimensionPixelSize(C0003R.dimen.notification_right_icon_size);
                    i = z - (resources.getDimensionPixelSize(C0003R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0003R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, z, i, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0003R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                ...
                if (VERSION.SDK_INT >= true) {
                    remoteViews.setImageViewBitmap(C0003R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0003R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0003R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0003R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0003R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle) {
                remoteViews.setTextViewText(C0003R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText) {
                remoteViews.setTextViewText(C0003R.id.text, this.mBuilder.mContentText);
                z = true;
            } else {
                z = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0003R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0003R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0003R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0003R.id.info, resources.getString(C0003R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0003R.id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0003R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0003R.id.info, 8);
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0003R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0003R.id.text2, this.mBuilder.mContentText);
                        ...
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            if (this.mBuilder.mUseChronometer != 0 || VERSION.SDK_INT < 16) {
                                ...
                                remoteViews.setLong(C0003R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            } else {
                                remoteViews.setViewVisibility(C0003R.id.chronometer, 0);
                                remoteViews.setLong(C0003R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                                remoteViews.setBoolean(C0003R.id.chronometer, "setStarted", true);
                            }
                            i = 1;
                        }
                        remoteViews.setViewVisibility(C0003R.id.right_side, i == 0 ? 0 : 8);
                        i = C0003R.id.line3;
                        if (z) {
                            i2 = 0;
                        }
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        @RestrictTo({Scope.LIBRARY_GROUP})
        public static final android.support.v4.app.NotificationCompatBase.Action.Factory FACTORY = new C04291();
        ...
        static class C04291 implements android.support.v4.app.NotificationCompatBase.Action.Factory {
            C04291() {
            }
...
*/
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final Factory FACTORY = new C04301();
            ...
            static class C04301 implements Factory {
                C04301() {
                }
