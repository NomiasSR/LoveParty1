...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C04331 implements StyleExtractor<FontInfo> {
        C04331() {
        }
    ...
    class C04342 implements StyleExtractor<FontFileResourceEntry> {
        C04342() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C04331());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C04342());
    }
