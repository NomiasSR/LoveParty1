...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0055R.id.media_actions);
            if (i > 0) {
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    applyStandardTemplate.addView(C0055R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0055R.id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0055R.id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0055R.id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0055R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0055R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0055R.id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0055R.id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0055R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0055R.id.action0, action.getIcon());
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0055R.id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0055R.id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0055R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0055R.id.cancel_action, 0);
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0055R.layout.notification_template_big_media_narrow : C0055R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0055R.layout.notification_template_big_media_narrow_custom : C0055R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            remoteViews.setInt(C0055R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
